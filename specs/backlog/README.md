...
| --- | --- | --- |
| [Shared Persistent Storage](./01-shared-persistent-storage/README.md) | P0 | None |
| [Provider Identity Extraction](./02-provider-identity-extraction/README.md) | P0 | Provider registry shape |
| [Host Auth Sync](./03-host-auth-sync/README.md) | P0 | Storage, identity extraction |
| [Account Deduplication](./04-account-deduplication/README.md) | P0 | Storage, identity extraction |
| [Multi-Account Inventory](./05-multi-account-inventory/README.md) | P0 | Storage, auth sync, deduplication |
...
| [Exhausted-Account Tracking](./11-exhausted-account-tracking/README.md) | P1 | Storage, inventory |
| [Rate-Limit Detection](./12-rate-limit-detection/README.md) | P2 | Server plugin hooks |
| [Safe Retry Attribution](./13-safe-retry-attribution/README.md) | P2 | Request tracking, auth timeline, identity fingerprints |
